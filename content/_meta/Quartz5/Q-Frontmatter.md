This plugin parses the frontmatter of the page using the [gray-matter](https://github.com/jonschlinkert/gray-matter) library and optionally displays selected properties in a collapsible panel. See [authoring content > Syntax](https://quartz.jzhao.xyz/authoring-content#syntax), [Obsidian compatibility](https://quartz.jzhao.xyz/features/obsidian-compatibility) and [OxHugo compatibility](https://quartz.jzhao.xyz/features/oxhugo-compatibility) for more information.
